...
github = ["https://github.com/DisonUyoga/disonobudho.git"]
...
![Homepage Screenshot](https://res.cloudinary.com/dfjpdzsin/image/upload/hugohomepage_k5e7ln.png "Homepage Screenshot")
...
![About Screenshot](https://res.cloudinary.com/dfjpdzsin/image/upload/about_zqk9z9.png "About Screenshot")
...
![](https://res.cloudinary.com/dfjpdzsin/image/upload/blog_jaewqo.png)
...
![](https://res.cloudinary.com/dfjpdzsin/image/upload/portfolio_gr17bg.png)

This allows you to describe the projects you have created in order to showcase them to people looking at your site.

### Contact

![](https://res.cloudinary.com/dfjpdzsin/image/upload/contact_mrc2nx.png)
...
```bash
# Cloning
git clone https://github.com/DisonUyoga/disonobudho.git
```
...
# Meta data
description = "The website of Dison Obdho,Bsc Computer Science"
author = "Dison Obudho"
...
social:
  twitter: ""
  linkedin: dison-uyoga-0827682a7
  github: samrobbins85
  gitlab: ""
  facebook: ""
  instagram: ""
  gmail: disonobudho233
```
